...
public class Api {
	...
	// 发帖
	public static final String NewTopic = "http://m.local.gkong.com/API/BBS_New_Topic.ashx";
	// 回帖
//	public static final String RepayTopic = "http://m.local.gkong.com/API/BBS_Repay_Topic.ashx";
